...
import com.ewoudje.spooky.blockentities.SealBlockEntity
import com.ewoudje.spooky.client.SpookyRenderTypes
import com.ewoudje.spooky.client.models.SpookyModels
import com.ewoudje.spooky.client.renderers.blockentity.SealHackerBlockEntityRenderer.Companion.renderPrismarineModel
...
class SealBlockEntityRenderer(ctx: BlockEntityRendererProvider.Context) : BlockEntityRenderer<SealBlockEntity> {
    private val leftLid = BakedModelRenderable.of(SpookyModels.SEAL_LEFT).withContext(BakedModelRenderable.Context(ModelData.EMPTY))
    private val rightLid = BakedModelRenderable.of(SpookyModels.SEAL_RIGHT).withContext(BakedModelRenderable.Context(ModelData.EMPTY))
