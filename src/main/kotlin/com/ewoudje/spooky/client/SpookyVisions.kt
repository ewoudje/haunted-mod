...
object SpookyVisions {
    ...
    val REGISTRY_KEY = ResourceKey.createRegistryKey<Vision>(ResourceLocation.fromNamespaceAndPath(SpookyMod.ID, "visions"))
    val REGISTRY = RegistryBuilder(REGISTRY_KEY)
        .onBake(::bakeVision)
        .sync(false)
        .create()

    val DEFFERED_REGISTRY = DeferredRegister.create(REGISTRY_KEY, SpookyMod.ID)
