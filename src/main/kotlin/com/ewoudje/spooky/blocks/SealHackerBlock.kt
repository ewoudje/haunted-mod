...
class SealHackerBlock(properties: Properties) : BaseEntityBlock(properties) {
    ...
    override fun useItemOn(
        ...
        if (!stack.`is`(SpookyItems.REDSTONE_ENGRAVED_DIAMOND)) return ItemInteractionResult.FAIL
    ...
    override fun onRemove(
        ...
        if (be.isSlotted())
            Containers.dropItemStack(level, pos.x.toDouble(), pos.y.toDouble(), pos.z.toDouble(), ItemStack(SpookyItems.REDSTONE_ENGRAVED_DIAMOND))
