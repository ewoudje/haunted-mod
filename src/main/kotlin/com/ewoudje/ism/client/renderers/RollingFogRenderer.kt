...
import com.ewoudje.ism.client.FogTextureBuilder
import com.ewoudje.ism.client.IsmShaders
...
object RollingFogRenderer {
    ...
    fun render(viewMatrix: Matrix4fc, partialTick: Float) {
        ...
        grabDepthBuffer()
        setupUniforms(IsmShaders.ROLLING_FOG, viewMatrix, fogPosition)
        blit(renderTarget)
    }
    ...
    private fun blit(target: RenderTarget) {
        ...
        RenderSystem.setShader(IsmShaders::ROLLING_FOG)
