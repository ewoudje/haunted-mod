...
import com.ewoudje.ism.world.structures.processor.ReplacingProcessor
...
class EvilGodSealStructure(
    ...
    override fun type(): StructureType<*> = IsmStructures.EVIL_GOD_SEAL_TYPE
    ...
    class Piece: TemplateStructurePiece {
        constructor(structureTemplateManager: StructureTemplateManager, templatePosition: BlockPos):
                super(IsmStructurePieces.EVIL_GOD_SEAL,
                    0,
        ...
        constructor(structureTemplateManager: StructureTemplateManager, tag: CompoundTag):
                super(IsmStructurePieces.EVIL_GOD_SEAL, tag, structureTemplateManager, ::makeSettings)
